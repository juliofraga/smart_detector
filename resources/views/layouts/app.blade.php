...
<html lang="pt-br">
    ...
    <body>
        <div id="app">
                            ...
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0 w-100 d-flex">
                                ...
                                <li class="nav-item dropdown ms-md-auto">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" href="{{ route('my-account') }}">{{ __('text.my_account') }}</a>
                                        </li>
                                        <li>
            ...
            <footer>
                <p>&copy; 2025 SmartDetector. {{ __('text.all_rights_reserved') }}</p>
            </footer>
        </div>
    </body>
</html>
