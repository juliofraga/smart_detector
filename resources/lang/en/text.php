...
return [
    ...
    'event_attributes_domain' => [
        ...
        'inform_table_column' => 'Specify whether the field should be displayed as a column in the event table',
    ...
    'login_domain' => [
        'access' => 'Access',
        'email' => 'Email',
        'error_login_attempt' => 'Error while trying to access the system',
        'inform_your_credentials' => 'Enter your credentials',
        'password' => 'Password'
    ],
    'modal_delete_domain' => [
    ...
    'user_domain' => [
        ...
        'inform_name' => 'Enter the name',
        'inform_password' => 'Enter the password',
        'inform_user_profile' => 'Select the user profile',
        'inform_valid_email' => 'Enter a valid email',
        'last_access' => 'Last Access',
        'last_update' => 'Last Update',
        'mininum_characters' => 'Minimum of 8 characters',
        'name' => 'Name',
        ...
        'password' => 'Password',
        'password_no_match' => 'This password does not match the previous one or is empty',
